    ...
    private void refreshAd() {
        ...
        builder.forUnifiedNativeAd(new UnifiedNativeAd.OnUnifiedNativeAdLoadedListener() {
            ...
            public void onUnifiedNativeAdLoaded(UnifiedNativeAd unifiedNativeAd) {
                ...
                UnifiedNativeAdView adView = (UnifiedNativeAdView) getLayoutInflater().inflate(R.layout.ad_unified, null, false);
        ...
        AdLoader adLoader = builder.withAdListener(new AdListener() {
            ...
            public void onAdFailedToLoad(int errorCode) {
                //refresh.setEnabled(true);
                Toast.makeText(UpdateVersionActivity.this, "Failed to load native ad: " + errorCode, Toast.LENGTH_SHORT).show();
            }
        }).build();

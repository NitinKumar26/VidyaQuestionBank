...
public class AppConfig {
    ...
    //Login URL
    public static final String URL_LOGIN = "http://qb.vidyastore.in/api/UserAuth";

    //SignUp URL
    public static final String URL_SIGNUP = "http://qb.vidyastore.in/api/UserRegistration";
    ...
    //Class Chapters URL
    public static final String URL_ACTIVITIES = "http://qb.vidyastore.in/api/GetActivities";
